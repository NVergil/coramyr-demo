              ...
              <div key={i} className="bg-white border border-gray-100 rounded-2xl overflow-hidden transition-all duration-200">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-medium text-gray-900 group-hover:text-teal-700 transition-colors">{faq.q}</span>
                  </div>
                  {openFaq === i ? (
                    <ChevronUp className="w-5 h-5 text-teal-600 flex-shrink-0 ml-4" />
                  ) : (
                    <ChevronDown className="w-5 h-5 text-gray-400 flex-shrink-0 ml-4 group-hover:text-teal-600 transition-colors" />
                  )}
                </button>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-12">
            ...
            <div className="flex flex-col items-center md:items-end gap-6">
              ...
              <div className="flex items-center gap-4">
                <a href="https://www.facebook.com/coramyr/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center text-gray-500 hover:bg-teal-50 hover:text-teal-700 transition-colors cursor-pointer">
                  <FacebookIcon className="w-5 h-5" />
                </a>
                <a href="https://www.instagram.com/dr.miriam_cabanas_alvistegui/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center text-gray-500 hover:bg-teal-50 hover:text-teal-700 transition-colors cursor-pointer">
                  <InstagramIcon className="w-5 h-5" />
                </a>
                <a href="https://www.tiktok.com/@radiestesia_medica" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center text-gray-500 hover:bg-teal-50 hover:text-teal-700 transition-colors cursor-pointer">
