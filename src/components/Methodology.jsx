        ...
        <section className="py-24 bg-slate-50" id="methodology">
            <div className="max-w-6xl mx-auto px-6">
                ...
                <div className="bg-white border border-slate-100 rounded-3xl overflow-hidden shadow-sm">
                    {/* Header para Desktop */}
                    <div className="hidden md:grid grid-cols-12 gap-6 p-6 bg-slate-100/50 border-b border-slate-100 text-teal-900 font-semibold text-sm">
                        ...
                        {steps.map((step, index) => (
                            <div key={index} className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 p-6 hover:bg-slate-50/50 transition-colors">
                                ...
                                <div className="col-span-1 md:col-span-3 flex items-center">
                                    <div>
                                        <div className="text-[10px] font-bold text-teal-700 uppercase tracking-wider mb-1 md:hidden">Fase del Tratamiento</div>
                                        <div className="font-medium text-gray-900">{step.phase}</div>
                                    </div>
                                </div>
                                <div className="col-span-1 md:col-span-5 flex items-center">
                                    <div>
                                        <div className="text-[10px] font-bold text-teal-700 uppercase tracking-wider mb-1 md:hidden">Acción Realizada</div>
                                ...
                                <div className="col-span-1 md:col-span-4 flex items-center">
                                    <div>
                                        <div className="text-[10px] font-bold text-teal-700 uppercase tracking-wider mb-1 md:hidden">Herramienta Utilizada</div>
